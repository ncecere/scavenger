...
import (
	...
	"github.com/ncecere/scavenger/scavenger/internal/config"
	"github.com/ncecere/scavenger/scavenger/internal/scraper"
)
...
func init() {
	...
	rootCmd.PersistentFlags().StringVar(&cfgFile, "config", "", "config file (default is $HOME/.scavenger.yaml)")
